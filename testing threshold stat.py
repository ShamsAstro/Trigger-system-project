...
while True:
    ...
    if np.abs(signal[counter]) >= threshold:
        # print("Signal!")
    ...
    if len(signal)%200 == 0:
        ...
        print("On plot : ", counter//200)
        print("There are ", len(events)," triggers!")
        print("The ratio of triggers to to signal is: ",triggers/len(t_axis) )
