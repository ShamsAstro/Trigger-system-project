...
def display_stats(signal_1, signal_2, t_axis, threshold):
    ...
    plt.show()
    plt.clf()
    # file_name="plot "+ str(counter_1//200)+ ".png"
...
while True:
    ...
    if cond_1 == False or wave_count_1 > 100:
        simulated_sig_1 = np.append(simulated_sig_1, 0)

    if cond_2 == False or wave_count_2 > 100:
    ...
    signal_1 = np.append(signal_1,  simulated_sig_1[wave_count_1])
    signal_2 = np.append(signal_2,  simulated_sig_2[wave_count_2])

    """
    if signal_1[counter_1] >= threshold:
        # print("signal_1!")
        events = np.append(events, t_axis[counter_1])
    """
